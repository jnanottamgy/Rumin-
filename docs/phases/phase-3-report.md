...
| **Planned functionality** | A cheaper freshness check; skipping unchanged rebuilds; a review workflow for flagged candidates and issues; citations for curated relationships; attribute history; indexed text search ([roadmap](../roadmap.md#graph-follow-ups-before-or-alongside-phase-5)) |
