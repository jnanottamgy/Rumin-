...
// Phase 9: advanced analyses of an execution, and the model verification register.
export type AnalysisTargets = Schemas["AnalysisTargetsRead"];
export type AnalysisTarget = Schemas["AnalysisTargetRead"];
export type AnalysisMetric = Schemas["AnalysisMetricRead"];
export type MonteCarloRequest = Schemas["MonteCarloRequest"];
export type JointSensitivityRequest = Schemas["JointSensitivityRequest"];
export type ScenarioAnalysisRequest = MonteCarloRequest | JointSensitivityRequest;
export type DistributionInput = MonteCarloRequest["quantities"][number]["distribution"];
export type ScenarioAnalysis = Schemas["ScenarioAnalysisRead"];
export type ScenarioAnalysisSummary = Schemas["ScenarioAnalysisSummaryRead"];
export type ScenarioAnalysisList = Schemas["ScenarioAnalysisList"];
export type AnalysisVerification = Schemas["AnalysisVerificationRead"];
export type MonteCarloResults = Schemas["MonteCarloResultsRead"];
export type JointResults = Schemas["JointResultsRead"];
export type HistogramBin = Schemas["HistogramBinRead"];
export type ConvergenceCheckpoint = Schemas["CheckpointRead"];
export type ModelVerification = Schemas["ModelVerificationRead"];
export type VerificationCheck = Schemas["VerificationCheckRead"];
